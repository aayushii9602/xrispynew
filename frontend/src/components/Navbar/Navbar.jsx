    ...
    <Disclosure as="nav" className="navbar relative">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-auto items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div
                  onClick={() => navigate("/")}
                  className="flex w-[15%] p-3 lg:w-[8%] flex-shrink-0 items-center">
                  <img
                    className="block w-[100%] lg:hidden"
                    src={logo}
                    alt="bits n bytes logo"
                  />
                  <img
                ...
                <div className="hidden sm:ml-6  sm:flex items-center">
                  <div className="flex  space-x-4 align-center justify-center flex m-auto">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        ...
                        className={classNames(
                          ...
                          'px-3 py-2 rounded-md text-sm font-medium text-xl'
                        )}
                        aria-current={item.current ? 'page' : undefined}
                        onClick={(e) => changeDir(item?.href)}
                      >
                        {item.name}
                      </a>
                    ))}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="rounded-full ml-2 bg-gray-800 p-2 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
          ...
          <Disclosure.Panel className="sm:hidden navbar-mob">
          ...
          <div className='h-10 absolute bg-black bottom-0'>
